...
public class DataCacher {
	...
	private static final long NEVER_CACHE = 0;
	private static final long NEVER_RELOAD = -1;

	private static final DataCacher dc = new DataCacher(NEVER_RELOAD); 
	...
	public DataCacher(long cacheExpiration) {
	...
	private String getCacheIndexFile(String path) {
		...
		try {
			cacheFileName = cacheDir.getCanonicalPath() + cacheDir.separator + path.hashCode() + ".xml";
